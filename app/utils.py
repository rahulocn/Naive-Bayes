...
def get_probability(favourable_outcomes,total_possible_outcomes):
	if type(favourable_outcomes) is int and type(total_possible_outcomes) is int and favourable_outcomes>-1 and total_possible_outcomes>0  and favourable_outcomes<=total_possible_outcomes:
...
if __name__=="__main__":
	...
	print p
	print get_probability_percentage(p)
